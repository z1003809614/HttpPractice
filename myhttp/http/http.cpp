...
namespace myhttp
{
    namespace http
    {
        ...
        bool CaseInsensitiLess::operator() (const std::string& lhs, const std::string& rhs) const{
...
//====================================Response================================================
        ...
        std::string HttpResponse::getHead(const std::string& key, const std::string& def) const{
            auto it  = m_headers.find(key);
            return it == m_headers.end() ? def : it->second;
        }
