...
namespace myhttp
{
    namespace http
    {
        ...
        static myhttp::ConfigVar<uint64_t>::ptr g_http_response_buffer_size = 
            myhttp::Config::Lookup("http.response.buffer_size", (uint64_t)(4 * 1024ull), "http response buffer size");
